...
/**
 * https://www.cnblogs.com/loytime/p/9957092.html
...
public class ImageMerge {
    ...
    public static void overlyingImageTest() {
        ...
        String sourceFilePath = "E://测试文件//marge//壁纸1.jpg";
        String waterFilePath = "E://测试文件//marge//壁纸2.jpg";
        String saveFilePath = "E://测试文件//marge//overlyingImageNew.jpg";
        try {
    ...
    public static void imageMargeTest() {
        ...
        String saveFilePath = "E://测试文件//marge//壁纸1.jpg";
        String divingPath = "E://测试文件//marge//壁纸2.jpg";
        String margeImagePath = "E://测试文件//marge//margeNew.jpg";
